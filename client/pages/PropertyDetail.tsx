...
/* =========================================================
   ...
   → exactly 3 marks: TL, center, BR (diagonal)
========================================================= */
function WatermarkLayer({
  ...
  const grid =
    copies === 3
      ...
      : baseGrid.slice(0, Math.min(9, Math.max(1, copies)));
...
/* =========================================================
   Fullscreen Lightbox Modal – original image, no pixel fatna
========================================================= */
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="absolute top-4 right-4 z-50 rounded-full p-2 bg-black/70 hover:bg-black text-white shadow-lg"
          aria-label="Close"
        >
          <X className="w-6 h-6" />
        </button>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6">
                  ...
                  />
                  <KV k="RERA" v={property.meta?.reraId || details.reraId} />
                  <KV
                    k="Posted On"
                    v={
