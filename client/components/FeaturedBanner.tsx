...
import { Star, ChevronLeft, ChevronRight, MapPin, Bed, Bath, Square } from "lucide-react";
...
export default function FeaturedBanner() {
  ...
  useEffect(() => {
    const fetchFeatured = async () => {
      try {
        const res = await fetch("/api/properties/approved-featured");
        if (res.ok) {
  ...
  const getLocationText = (loc: FeaturedProperty["location"]) => {
        ...
        >
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <span className="font-bold text-sm sm:text-base">Featured Properties</span>
              <p className="text-xs sm:text-sm opacity-90">Get premium visibility for your listing</p>
            </div>
          </div>
          <button
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="bg-blue-700 text-white px-2 py-0.5 rounded-full text-xs font-medium">
        ...
        <div className="relative">
          <div className="overflow-hidden rounded-lg touch-pan-y select-none">
            <div
              ref={trackRef}
                    ...
                    >
                      <div className="relative h-48 md:h-56">
                        ...
                        <div className="absolute top-4 left-4 flex gap-2">
                          <span className="bg-blue-700 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg flex items-center gap-1">
